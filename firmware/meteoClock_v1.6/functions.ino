...
void redrawPlot() {
  ...
  switch (mode) {             // добавлена переменная для "растягивания" графика до фактических максимальных и(или) минимальных значений(с)НР
    case 1: drawPlot(0, 3, 15, 4, CO2_MIN, CO2_MAX, co2Hour, "c ", "hr", mode, 10, 0);
      break;
    case 2: drawPlot(0, 3, 15, 4, CO2_MIN, CO2_MAX, co2Day, "c ", "da", mode, 10, 0);
      break;
    case 3: drawPlot(0, 3, 15, 4, HUM_MIN, HUM_MAX, humHour, "h%", "hr", mode, 1, 0);
      break;
    case 4: drawPlot(0, 3, 15, 4, HUM_MIN, HUM_MAX, humDay, "h%", "da", mode, 1, 0);
      break;
    case 5: drawPlot(0, 3, 15, 4, TEMP_MIN, TEMP_MAX, tempHour, "t\337", "hr", mode, 1, -TEMP_K);
      break;
    case 6: drawPlot(0, 3, 15, 4, TEMP_MIN, TEMP_MAX, tempDay, "t\337", "da", mode, 1, -TEMP_K);
      break;
    ...
    case 7:
#if (PRESSURE == 1)
      drawPlot(0, 3, 15, 4, RAIN_MIN, RAIN_MAX, pressHour, "r ", "hr", mode, 1, -RAIN_K);
#else
      drawPlot(0, 3, 15, 4, PRESS_MIN, PRESS_MAX, pressHour, "p ", "hr", mode, 1, -PRESS_K);
#endif
      break;
    case 8:
#if (PRESSURE == 1)
      drawPlot(0, 3, 15, 4, RAIN_MIN, RAIN_MAX, pressDay, "r ", "da", mode, 1, -RAIN_K);
#else
      drawPlot(0, 3, 15, 4, PRESS_MIN, PRESS_MAX, pressDay, "p ", "da", mode, 1, -PRESS_K);
#endif
      break;
    case 9: drawPlot(0, 3, 15, 4, ALT_MIN, ALT_MAX, altHour, "m ", "hr", mode, 10, 0);
      break;
    case 10: drawPlot(0, 3, 15, 4, ALT_MIN, ALT_MAX, altDay, "m ", "da", mode, 10, 0);
      break;
  }
#else                         // для дисплея 1602
  switch (mode) {
    case 1: drawPlot(0, 1, 11, 2, CO2_MIN, CO2_MAX, co2Hour, "c", "h", mode, 10, 0);
      break;
    case 2: drawPlot(0, 1, 11, 2, CO2_MIN, CO2_MAX, co2Day, "c", "d", mode, 10, 0);
      break;
    case 3: drawPlot(0, 1, 11, 2, HUM_MIN, HUM_MAX, humHour, "h", "h", mode, 1, 0);
      break;
    case 4: drawPlot(0, 1, 11, 2, HUM_MIN, HUM_MAX, humDay, "h", "d", mode, 1, 0);
      break;
    case 5: drawPlot(0, 1, 11, 2, TEMP_MIN, TEMP_MAX, tempHour, "t", "h", mode, 1, -TEMP_K);
      break;
    case 6: drawPlot(0, 1, 11, 2, TEMP_MIN, TEMP_MAX, tempDay, "t", "d", mode, 1, -TEMP_K);
      break;
    ...
    case 7:
#if (PRESSURE == 1)
      drawPlot(0, 1, 11, 2, RAIN_MIN, RAIN_MAX, pressHour, "r", "h", mode, 1, -RAIN_K);
#else
      drawPlot(0, 1, 11, 2, PRESS_MIN, PRESS_MAX, pressHour, "p", "h", mode, 1, -PRESS_K);
#endif
      break;
    case 8:
#if (PRESSURE == 1)
      drawPlot(0, 1, 11, 2, RAIN_MIN, RAIN_MAX, pressDay, "r", "d", mode, 1, -RAIN_K);
#else
      drawPlot(0, 1, 11, 2, PRESS_MIN, PRESS_MAX, pressDay, "p", "d", mode, 1, -PRESS_K);
#endif
      break;
    case 9: drawPlot(0, 1, 11, 2, ALT_MIN, ALT_MAX, altHour, "m", "h", mode, 10, 0);
      break;
    case 10: drawPlot(0, 1, 11, 2, ALT_MIN, ALT_MAX, altDay, "m", "d", mode, 10, 0);
      break;
  }
#endif
}
...
void readSensors() {
  ...
  dispTemp = bme.readTemperature() + TEMP_CORRECTION;
...
void plotSensorsTick() {
  ...
  if (testTimer(hourPlotTimerD, hourPlotTimer)) {
    ...
    tempHour[14] = (byte)(dispTemp + TEMP_K);
    humHour[14] = dispHum;
    altHour[14] = (byte)(dispAlt / 10);
    co2Hour[14] = (byte)(dispCO2 / 10);

    if (PRESSURE) pressHour[14] = (byte)(dispRain + RAIN_K);
    else pressHour[14] = (byte)(dispPres + PRESS_K);
  }
  ...
  if (testTimer(dayPlotTimerD, dayPlotTimer)) {
    ...
    tempDay[14] = (byte)averTemp;
    humDay[14] = (byte)averHum;
    pressDay[14] = (byte)averPress;
    altDay[14] = (byte)averAlt;
    co2Day[14] = (byte)averCO2;
  }
